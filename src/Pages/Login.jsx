...
const Login = () => {
    const {Googlesingin,sinigemail}= useContext(AuthContext)
    const handlegoogle = ()=>{
        Googlesingin()
        .then(result=>{
...
<div className="w-full max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form onSubmit={handleRegister} className="space-y-6" action="#">
        ...
        <p>Continue with <button onClick={handlegoogle} className="btn btn-secondary w-full">Google</button></p>
    </form>
